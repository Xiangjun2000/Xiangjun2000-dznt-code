...
%%%
Z1_12=xt1_12-alph_f1_12-p1_12*peta1_12/(1+peta1_12^2)^(1/2);
Z1_22=xt1_22-alph_f1_22-p1_22*peta1_22/(1+peta1_22^2)^(1/2);
Z1_32=xt1_32-alph_f1_32-p1_32*peta1_32/(1+peta1_32^2)^(1/2);
Z1_42=xt1_42-alph_f1_42-p1_42*peta1_42/(1+peta1_42^2)^(1/2);

Z2_12=xt2_12-alph_f2_12-p2_12*peta2_12/(1+peta2_12^2)^(1/2);
Z2_22=xt2_22-alph_f2_22-p2_22*peta2_22/(1+peta2_22^2)^(1/2);
Z2_32=xt2_32-alph_f2_32-p2_32*peta2_32/(1+peta2_32^2)^(1/2);
Z2_42=xt2_42-alph_f2_42-p2_42*peta2_42/(1+peta2_42^2)^(1/2);
...
%辅助系统
dpeta1_12 = (((1+peta1_12^2)^(3/2))/p1_12)*(-per1_1*peta1_12+Su1_1-u1_1);
dpeta1_22 = (((1+peta1_22^2)^(3/2))/p1_22)*(-per1_2*peta1_22+Su1_2-u1_2);
dpeta1_32 = (((1+peta1_32^2)^(3/2))/p1_32)*(-per1_3*peta1_32+Su1_3-u1_3);
dpeta1_42 = (((1+peta1_42^2)^(3/2))/p1_42)*(-per1_4*peta1_42+Su1_4-u1_4);

dpeta2_12 = (((1+peta2_12^2)^(3/2))/p2_12)*(-per2_1*peta2_12+Su2_1-u2_1);
dpeta2_22 = (((1+peta2_22^2)^(3/2))/p2_22)*(-per2_2*peta2_22+Su2_2-u2_2);
dpeta2_32 = (((1+peta2_32^2)^(3/2))/p2_32)*(-per2_3*peta2_32+Su2_3-u2_3);
dpeta2_42 = (((1+peta2_42^2)^(3/2))/p2_42)*(-per2_4*peta2_42+Su2_4-u2_4);
